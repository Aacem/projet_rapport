            ...
            <ul>
               ...
               <hr style={{color:"white"}} />
                       ...
                       <li> <i className="fas fa-book text-white"></i> <Link  to="/dashboard/issue_return" 
                         style={{textDecoration:"none",color:"#f1f1f1",fontSize:"20px",marginLeft:"5px",fontFamily:"Oswald"}}> Today Issued Books </Link>  </li>
                       <hr style={{color:"white"}} />
                       <li> <i className="fas fa-book text-white"></i> <Link  to="/dashboard/returnBook" 
                         style={{textDecoration:"none",color:"#f1f1f1",fontSize:"20px",marginLeft:"5px",fontFamily:"Oswald"}}> Today Returned Books </Link>  </li>
                       <hr style={{color:"white"}} />
