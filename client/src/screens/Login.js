...
<img src={StudentIMage} alt="StudentIMage" style={{height:"220px",width:"220px",borderRadius:"50%"}} />
                    <div style={{marginTop:"20px"}}>
                        <input type="text" className="form-control" style={{height:"60px",borderRadius:"20px"}}
                         placeholder="Username" value={roll_no} onChange={(e) => setRoll_no(e.target.value)} />
                    </div>
                    <br />
                    <div>
                    ...
                    <br />
                    <Link to="/register"  style={{fontFamily:"sans-serif",color:"yellow",textDecoration:"none"}}>If you don't have an account then Register Here</Link>
